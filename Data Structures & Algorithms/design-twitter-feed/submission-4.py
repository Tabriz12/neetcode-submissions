...
class Twitter:
    ...
    def follow(self, followerId: int, followeeId: int) -> None:
        ...
        self.follosh[followerId].add(followeeId) if followerId != followeeId else None
        

    def unfollow(self, followerId: int, followeeId: int) -> None:

        self.follosh[followerId].discard(followeeId) if followerId != followeeId else  None
